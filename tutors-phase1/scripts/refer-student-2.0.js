...
$(document).ready(function () {
    ...
    $('input[name="referralreason"]').change(function () {
        ...
        $('#disConfN, #disConfY, #disconf, #health2, #details1i, #details, #details1h, #h_disabilityInfo, #tbLetter, #tbLetterS, #tbNonLetter, #trLetter1, #trLetter2, #submit').removeClass('show');
        ...
        manage('#rassnosub', '#h_assigmentnonsub, #tbLetter, #LSF4, #submit');
        manage('#rprogcon', '#h_concerns, #MessageI, #details, #submit');
        manage('#rexamsupp', '#h_examsupport, #MessageJ, #details, #submit');
        manage('#rstudyskills', '#h_studyskills, #tbLetter, #LSF3, #submit');
        manage('#rengaged', '#h_nonengagement, #tbLetterS, #details, #LSF5, #submit');
        manage('#rwithdraw', '#h_withdrawal, #tbLetterS, #details, #LSF6, #submit');
